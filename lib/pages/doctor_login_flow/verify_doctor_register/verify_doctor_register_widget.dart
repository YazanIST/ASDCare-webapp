...
class VerifyDoctorRegisterWidget extends StatefulWidget {
  const VerifyDoctorRegisterWidget({
    super.key,
    required this.email,
  ...
  @override
  State<VerifyDoctorRegisterWidget> createState() =>
      _VerifyDoctorRegisterWidgetState();
}

class _VerifyDoctorRegisterWidgetState extends State<VerifyDoctorRegisterWidget>
    with TickerProviderStateMixin {
  late VerifyDoctorRegisterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerifyDoctorRegisterModel());
