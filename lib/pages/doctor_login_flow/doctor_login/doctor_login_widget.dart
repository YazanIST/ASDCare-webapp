...
class DoctorLoginWidget extends StatefulWidget {
  const DoctorLoginWidget({super.key});

  @override
  State<DoctorLoginWidget> createState() => _DoctorLoginWidgetState();
}
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if ((_model.apiResult6tf?.succeeded ?? true)) {
                                ...
                                _model.children = await AuthServiceGroup
                                ...
                                if (((_model.children?.jsonBody ?? '')
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'You don\'t have any children assigned to you',
                                        style: TextStyle(
                                          color:
